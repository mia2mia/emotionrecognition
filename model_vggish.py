...
class emoLSTM():
    ...
    def build_model(self):
        ...
        self.model.add(Masking(mask_value=0.0, input_shape=(None, 128)))
    ...
    def fit(self, x_train, y_train,
        ...
        history = self.model.fit_generator(
                        generator=bucket_generator(x_train, y_train, batch_size=batch_size), 
...
if __name__ == "__main__":
    enn = emoLSTM()
    enn.model.summary()
    x_train = np.load('dataset_vggish/x_train.npy')
    y_train = np.load('dataset_vggish/y_train.npy')
    x_val = np.load('dataset_vggish/x_val.npy')
    y_val = np.load('dataset_vggish/y_val.npy')
